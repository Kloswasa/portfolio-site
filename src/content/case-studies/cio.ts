...
const cioCaseStudy = {
  ...
  hero: {
    ...
    summary:
      "A packaging structure that locks open at the ideal angle — so the product inside is easy to reach without the lid collapsing or flopping shut.",
    meta: [
      { label: "Client", value: "Concept project" },
      { label: "Role", value: "Packaging structure design" },
      { label: "Timeline", value: "4 weeks" },
      { label: "Deliverable", value: "Structural dieline + prototype" },
    ],
  },
  sections: {
    context: {
      ...
      blocks: [
        ...
        },
        {
          type: "stats",
          items: [
            { value: "1", label: "Lock angle", variant: "dark" },
            { value: "0", label: "Extra hardware", variant: "mid" },
      ...
      blocks: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              body: "Single-panel structural spec with score depths, catch tabs, and assembly sequence documented.",
            },
          ],
        },
        {
