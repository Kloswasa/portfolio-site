...
- num: "02"
  ...
  body: Hand-drawn botanicals digitised with consistent line language and two ink
    colours.
- num: "03"
  title: Layout + pattern
  body: Grid, typography, and derived geometric patterns built per ingredient
    chapter.
