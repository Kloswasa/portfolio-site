...
const recipeCaseStudy = {
  ...
  hero: {
    ...
    titleLine2: "Recipes",
    summary:
      "A recipe app for saving, sharing, and cooking dishes passed down across generations — with photos, stories, and measurements that match how people actually cook.",
    meta: [
    ...
    brief: {
      ...
      blocks: [
        ...
        },
        {
          type: "stats",
          items: [
            { value: "5", label: "Beta families", variant: "dark" },
            { value: "120+", label: "Recipes imported", variant: "mid" },
            { value: "12", label: "Week build", variant: "mid" },
            { value: "1", label: "Cook mode per screen", variant: "light" },
          ],
        },
        {
          type: "prose",
          ...
          items: [
            {
              ...
              body: "Recipes lived across Notes, WhatsApp threads, and handwritten cards with no unified search or lineage.",
            },
            {
              num: "B",
              label: "Friction 02",
    ...
    research: {
      ...
      blocks: [
        ...
        },
        {
          ...
          caption:
            "Journey map across import, library browsing, cook mode, and sharing. Amber = friction requiring a design response.",
    ...
    concept: {
      ...
      blocks: [
          ...
          items: [
            {
              ...
              body: "Mapped how five beta families stored recipes and where generic apps failed their workflows.",
            },
            {
              num: "02",
              title: "Library IA",
              body: "Collections by family branch replaced browse feeds. Search scoped to imported content only.",
            },
            {
              num: "03",
              title: "Cook mode",
              body: "One step per screen, large type, one-tap timers, imperial/metric toggle local to cook mode only.",
            },
            {
              num: "04",
              title: "Ship & share",
              body: "Responsive web app with share links for relatives without accounts and print-friendly recipe cards.",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          caption:
            "Primitive → semantic → component tokens for cards, cook mode, and library chrome. Typography scaled for arm's-length reading.",
      ...
      blocks: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              body: "Early adopters brought handwritten cards, WhatsApp forwards, and Notes exports into a single library.",
            },
            {
              value: "↑",
              label: "Cook mode completion",
              body: "One-step-per-screen cook mode improved completion versus the initial multi-step scroll prototype.",
            },
          ],
        },
        {
