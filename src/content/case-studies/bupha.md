...
- num: "01"
  ...
  body: Hand-drawn motifs digitised with consistent line weight and two-colour
    palette.
- num: "02"
  title: Label grid
...
- value: "3"
  label: Product labels
  body: Print-ready label artwork for three SKUs with shared system and unique
    motifs.
- value: ✓
  label: Client launch
