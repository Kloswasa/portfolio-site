...
const bhupCaseStudy = {
  ...
  hero: {
    ...
    eyebrow: "006 · Graphic design · Illustration",
    titleLine1: "Bhup",
    titleLine2: "Line",
    summary:
    ...
    meta: [
      ...
      { label: "Deliverable", value: "Label system + illustration set" },
    ],
  },
  sections: {
    context: {
      ...
      blocks: [
        ...
        },
        {
          type: "stats",
          items: [
            { value: "3", label: "Product labels", variant: "dark" },
            { value: "6", label: "Illustration motifs", variant: "mid" },
            { value: "3", label: "Week sprint", variant: "light" },
          ],
        },
      ],
    },
