...
const thaiHCaseStudy = {
  ...
  hero: {
    ...
    meta: [
      { label: "Client", value: "Concept / academic project" },
      { label: "Role", value: "Illustration + graphic design" },
      { label: "Timeline", value: "7 weeks" },
      { label: "Deliverable", value: "32-page infographic book" },
    ],
  },
  sections: {
    context: {
      ...
      blocks: [
        ...
        },
        {
          type: "stats",
          items: [
            { value: "32", label: "Pages", variant: "dark" },
            { value: "18", label: "Ingredient profiles", variant: "mid" },
            { value: "100%", label: "Original artwork", variant: "light" },
          ],
        },
      ],
    },
